...
class Slice extends Interaction{
    constructor(callback,x,y){
        super(callback);

        /* 1: Direction of the slice to do
            * 2: Direction drawed by the user
            */
        this.directionToDraw = glMatrix.vec2.fromValues(x, y) // 1
...
class Shake extends Interaction{
